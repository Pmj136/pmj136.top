      ...
      <div class="main--mobile">
        ...
        <div class="extra-wrap--mobile">
          ...
          <div class="action--mobile" v-if="!item.is_del">
            <div class="star--mobile" :style="{color:item.is_star?'#6cbd45':'#b2bac2'}" @click="executeStar(item)">
              <svg-icon icon="star"/>
      ...
      <div class="main--pc" :style="{'width':item.initial_img?'calc(100% - 90px)':'100%'}">
        ...
        <div class="action-wrap--pc">
          <template v-if="!item.is_del">
            <div class="action--pc" :style="{color:item.is_star?'#6cbd45':'#b2bac2'}" @click="executeStar(item)">
              <svg-icon icon="star"/>
