<template>
    <ul class="jiu-list">
            ...
            <div class="setting-list-item--content">
                ...
                <el-dialog
                    ...
                    <el-form :model="form" ref="form" :rules="emRules" size="medium" style="width: 100%">
                        ...
                        <el-form-item>
                            <el-button style="width: 100%" type="info" @click="bindEmail" :loading=isFetch>绑定
                            </el-button>
                        </el-form-item>
                    </el-form>
                </el-dialog>
        ...
        <li class="setting-list-item">
            ...
            <div class="setting-list-item--content">
                <span class="value-wrap" :class="{'value-bold':!!info.github_nick}">{{
                        info.github_nick || '绑定GitHub'
                    }}</span>
                <span class="action"
                      @click="handleBind(!!info.github_nick,'github')">{{ !!info.github_nick ? '解绑' : '绑定' }}</span>
            </div>
        </li>
        <li class="setting-list-item">
            <span class="setting-list-item--title">Gitee</span>
            <div class="setting-list-item--content">
                <span class="value-wrap" :class="{'value-bold':!!info.gitee_nick}">{{
                        info.gitee_nick || '绑定Gitee'
                    }}</span>
                <span class="action" @click="handleBind(!!info.gitee_nick,'gitee')">{{
                        !!info.gitee_nick ? '解绑' : '绑定'
                    }}</span>
            </div>
        </li>
        <li class="setting-list-item">
            ...
            <div class="setting-list-item--content">
                <span class="value-wrap" :class="{'value-bold':!!info.dingtalk_nick}">{{
                        info.dingtalk_nick || '绑定钉钉'
                    }}</span>
                <span class="action" @click="handleBind(!!info.dingtalk_nick,'dingtalk')">{{
                        !!info.dingtalk_nick ? '解绑' : '绑定'
                    }}</span>
            </div>
        </li>
        <li class="setting-list-item">
